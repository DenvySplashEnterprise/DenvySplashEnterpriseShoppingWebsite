		...
		<div class="w3l_banner_nav_right">
			...
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="adminNakedVulture@shop_denvysplash_com/Upload/Products/<?php echo $product_details['image']; ?>" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>GH&#8373; <?php echo $product_details['selling']; ?>/- <span>GH&#8373; <?php echo $product_details['price']; ?>/-</span></h4>
						</div>
