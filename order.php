...
<ul class="nav nav-tabs">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active" style="Overflow-x:scroll; Overflow-y:scroll;">
    ...
    <div id="menu1" class="tab-pane fade" style="Overflow-x:scroll; Overflow-y:scroll;">
