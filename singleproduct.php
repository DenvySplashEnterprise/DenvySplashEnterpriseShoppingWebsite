				...
				<div class="single-page-row" id="detail-21">
					...
					<div class="col-md-6 single-top-right">
						...
						<div class="single-rating">
							<ul>
								<span><?php echo averagestars(base64_decode($_GET['id'])); ?>
								
								<li class="rating"><?php echo totalreviews(base64_decode($_GET['id'])); ?> ratings</li></span>
						...
						<div class="single-price">
							<ul>
								...
								<li><a href="#" title="Coupons are not available yet!!!"><i class="fa fa-gift" aria-hidden="true"></i> Coupon (Not Available)</a></li>
							</ul>	
						</div> 
						...
						<form action="javascript:void(0);" method="post">
								<fieldset>
									...
									<!--a href='#' class='btn btn-info'><span class='glyphicon glyphicon-chevron-left' aria-hidden='true'></span>BACK TO PRODUCT </a-->
...
<!--//products--> 
 ...
 <button type="button" class="collapsible">View Reviews</button>
<div class="content" style="text_decoration:non;list-style-type:none;">
  <h2>All Reviews</h2><hr>
	<div class="allreviews"><?php 	echo allreviews(base64_decode($_GET['id'])); ?></div>
</div> 
