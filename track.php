...
<html>
<head>
<title>DEnVy Splash Enterprise | Track Order</title>
...
<section class="tracking">
	...
	<table class="table table-striped table-bordered" >
     	<tr>
     		<th>Order Placed <span style="color:red;">&#9742;</span></th>
     		<th>Order Confirmed <span style="">💵</span></th>
     		<th>Shipped <span style="">🚢</span></th>
     		<th>Item On The Way <span style="">🛵</span></th>
     		<th>Delivered <span style=""> 📬</span></th>
     	</tr>
     </table><br/><br/>
<div class="progress">
  ...
  <?php
       switch ($GlobalData['current_status']) {
        ...
        case 'Shipped':
         echo "
         <div class='progress-bar progress-bar-success' role='progressbar' aria-valuenow='50' aria-valuemin='0' aria-valuemax='100' style='width:0%'></div>
         ";
          break;
...
<div class="col-sm-12" style="border:1px solid #cfcfcf; padding:10px; border-radius: 6px;">
	<h5>Order ID : #ORDYVNED<?php echo $GlobalData['order_id'] ; ?><br/>
...
<div class="alert alert-success text-center"> Dear Customer, make payments to confirm your order. Cash On Delivery buyers are exempted since they will incur higher charges on delivery.<br/>
		Use "<a title="Go to 'My Account' tab, choose 'Order History' or 'Track Order' from the dropdown list to view your 'Order No.'">Order No.</a>" as your Mobile Money "<a>Reference</a>".
		<b>Thank you.</b>
</div>
